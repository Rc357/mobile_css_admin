...
class EditThankYouMessageDialog extends GetView<EditMessageController> {
  @override
    ...
    return FormBuilder(
      ...
      child: AlertDialog(
              ...
              () => Column(
                ...
                children: [
                  InputTextFieldWidget(
                    initialValue: controller.initialMessage.value!.message,
        ...
        actions: [
          TextButton(
            onPressed: () async {
              if (await controller.submitEditThankYouMessage()) {

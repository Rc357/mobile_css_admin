...
import 'package:admin/module/dashboard/dash_admin_office/widgets/pie_chart.dart';
import 'package:admin/module/dashboard/dash_admin_office/widgets/word_cloud.dart';
import 'package:admin/widgets/loading_indicator_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:get/get.dart';

class AdminOfficeRespondentsWidget
    extends GetView<AdminOfficeBarGraphController> {
  const AdminOfficeRespondentsWidget({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                border: Border.all(),
                borderRadius: BorderRadius.all(Radius.circular(5))),
            child: AdminOfficePieChartSample3(),
          ),
          SizedBox(

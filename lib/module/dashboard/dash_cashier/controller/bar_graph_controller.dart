...
enum CashierBarGraphControllerStatus { initial, loading, loaded, error }

class CashierBarGraphController extends GetxController {
  static CashierBarGraphController get instance => Get.find();
  late Worker _statusEverWorker;
  final _status = CashierBarGraphControllerStatus.initial.obs;
  bool get isLoading =>
  ...
  String currentState() =>
      'CashierBarGraphController(_status: ${_status.value} allQuestion: ${allQuestion.length},)';
  ...
  void _monitorFeedbackFormStatus() {
    _statusEverWorker = ever(
      ...
      (value) async {
        switch (value) {
          case CashierBarGraphControllerStatus.error:
            MyLogger.printError(currentState());
            break;
          case CashierBarGraphControllerStatus.loading:
            MyLogger.printInfo(currentState());
            break;
          case CashierBarGraphControllerStatus.initial:
            MyLogger.printInfo(currentState());
            break;
          case CashierBarGraphControllerStatus.loaded:
            MyLogger.printInfo(currentState());
            break;
        }
      },

...
class DeleteAdminDialog extends GetView<DeleteAdminStatus> {
  DeleteAdminDialog(this.adminData);
  final AdminModel adminData;

  final deleteAdminController = DeleteAdminController.instance;
  @override
        ...
        content: Container(
          ...
          child: Theme(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'All the data of the selected admin will permanently deleted.',
        ...
        actions: [
          TextButton(
            onPressed: () async {
              ...
              deleteAdminController.deleteAdmin(adminData);
            },
            child: Container(
